...
class HomeScreenData : NSObject, NSCoding{
	...
	init(fromJson json: JSON!){
        ...
        selfSurvey = json["selfSurvey"].stringValue as AnyObject
	}
	...
	func toDictionary() -> [String:Any]
	{
		...
		if selfSurvey != nil{
			dictionary["selfSurvey"] = selfSurvey
		}
		return dictionary
	}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         selfSurvey = aDecoder.decodeObject(forKey: "selfSurvey") as? AnyObject
